# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2018-07-06 08:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdatetime', models.DateTimeField(auto_now_add=True, verbose_name='Create time')),
                ('credential', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wssh.Credential')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='servers',
            field=models.ManyToManyField(related_name='servers', to='wssh.ServerInfor', verbose_name='Servers'),
        ),
        migrations.AddField(
            model_name='log',
            name='server',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wssh.ServerInfor', verbose_name='Server'),
        ),
        migrations.AddField(
            model_name='log',
            name='user',
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ManyToManyField(to='wssh.ServerGroup', verbose_name='Server group you want to execute'),
        ),
        migrations.AddField(
            model_name='commandlog',
            name='log',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wssh.Log', verbose_name='Log'),
        ),
